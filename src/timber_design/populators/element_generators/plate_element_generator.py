...
class PanelPlateElementGeneratorA(ElementGenerator):
    ...
    def __init__(self, panel:Panel, frame_panel: Panel, sheeting_inside: float|None = None, sheeting_outside: float|None = None, beam_width_overrides: dict|None = None, joint_rule_overrides: list[CategoryRule]|None = None) -> None:
