    ...
    def _create_recess_elements(self) -> None:
        ...
        for i, edge in self.edge_generator.edges.items():
            ...
            new_centerlines.append(
                edge.translated((vector * self.beam_dimensions["recess"][0] * 0.5) + Vector(0, 0, (self.slab.thickness - self.beam_dimensions["recess"][1]) * 0.5))
            )
        ...
        vector = Vector(0, 0, (self.slab.thickness * 0.5 - self.beam_dimensions["recess"][1]))
